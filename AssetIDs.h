...
#define ID_ANI_PIRANHAPLANT_CHOMP_RED_DOWN_LEFT (ID_ANI_PIRANHAPLANT_CHOMP_RED + 21)
#define ID_ANI_PIRANHAPLANT_CHOMP_RED_DOWN_LEFT (ID_ANI_PIRANHAPLANT_CHOMP_RED + 22)
